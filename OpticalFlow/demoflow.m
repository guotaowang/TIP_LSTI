...
% % load the two frames
% if wy<10 
%     wy1=strcat('0000',int2str(wy)); 
% elseif wy<100 
% wy1=strcat('0000',int2str(wy));
% % else wy1=strcat('0',int2str(wy));
% end;
% if wy+1<10 
% wy2=strcat('0000',int2str(wy+1)); 
% elseif wy+1<100 
% wy2=strcat('0000',int2str(wy+1)); 
...
im1 = imresize(imread('E:\LSTI_AAAI2018\OpticalFlow\00004.jpg'),[448,320]);
im2 = imresize(imread('E:\LSTI_AAAI2018\OpticalFlow\00005.jpg'),[448,320]);
